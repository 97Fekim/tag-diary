...
public class TagRepositoryTests {
    ...
    public void testInsertDummies(){
        ...
        repository.save(Tag.builder().tagName("사랑").tagType("emotion").tagColor("#c5efb4").build());
        repository.save(Tag.builder().tagName("뿌듯").tagType("emotion").tagColor("#af98ec").build());
        repository.save(Tag.builder().tagName("흐뭇").tagType("emotion").tagColor("#ecc088").build());
        repository.save(Tag.builder().tagName("감격").tagType("emotion").tagColor("#6ee4ac").build());
        repository.save(Tag.builder().tagName("감사").tagType("emotion").tagColor("#6cdbe4").build());
        repository.save(Tag.builder().tagName("만족").tagType("emotion").tagColor("#7890e4").build());
        repository.save(Tag.builder().tagName("황홀").tagType("emotion").tagColor("#e498df").build());
        ...
        repository.save(Tag.builder().tagName("설렘").tagType("emotion").tagColor("#75c3cb").build());
        ...
        repository.save(Tag.builder().tagName("따분함").tagType("emotion").tagColor("#accba4").build());
